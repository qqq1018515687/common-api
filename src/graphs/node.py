    ...
    try:
        ...
        try:
            ...
            task = {
                ...
                "result_fallback": db_task.result_fallback,
                "persistence_status": getattr(db_task, "persistence_status", None),
                "persistence_error": getattr(db_task, "persistence_error", None),
                "error": db_task.error,
